...
from pipelines.commands.utils.lazy_group import LazyGroup
from pipelines.utils import get_connector_modified_files, get_modified_connectors
...
@click.group(
    ...
    lazy_subcommands={
        "build": "pipelines.commands.groups.connectors.build.build",
